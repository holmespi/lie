...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_slider', (
            ...
            ('test', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('images', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
