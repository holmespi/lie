...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'content_product', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2014, 2, 26, 0, 0), unique=True, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.slug'
        db.delete_column(u'content_product', 'slug')
