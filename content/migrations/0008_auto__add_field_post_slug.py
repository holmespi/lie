...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'content_post', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2014, 3, 6, 0, 0), unique=True, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.slug'
        db.delete_column(u'content_post', 'slug')
